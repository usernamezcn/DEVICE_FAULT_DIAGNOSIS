...
for i in xload_data_from_orcale():
    ...
    DEVICECODE,name,Monitoring_type_parameter,LINKEDEQUIPMENT = i['DeviceCode'],i['MonitorTypeName'],i['Monitoring_type_parameter'],i['LINKEDEQUIPMENT']
    ...
    if max_ == min_:
        ...
        end_trend, end_mutation = coxStuart(data_list,threshold,slide,point),coxStuart(data_list,thresholdSudden,slideSudden,pointSudden)
    ...
    # Ins2Orc.insert_(result_dict=result_dict,LINKEDEQUIPMENT =LINKEDEQUIPMENT, DEVICECODE=DEVICECODE)
